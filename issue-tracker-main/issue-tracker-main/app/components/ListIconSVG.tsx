import "../css/ListIconSVG.css";

const ListIconSVG = () => {
  return (
    <div className="ListIconSvg">
      <svg
        className="MultiColorIcon MultiColorIcon ListMultiColorIcon MultiColorIcon--medium"
        viewBox="0 0 24 24"
        title="list"
